...
SELECT players.first_name, players.last_name FROM players INNER JOIN stats ON players.id = stats.player_id INNER JOIN teams ON teams.id = stats.team_id WHERE teams.name = "Chicago Cubs" and teams.year=2020;
